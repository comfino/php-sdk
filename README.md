...
[![Latest Version](https://img.shields.io/badge/release-3.0.0-blue.svg)](https://github.com/comfino/php-sdk/releases)
...
- Secure webhook handling with CR-Signature (SHA3-256) verification, per-tenant key resolution, replay protection
  and rate limiting.
- Multitenant-safe by design: every service is addressed by a tenant scope, and a stateless API client carries the
  credential per call instead of on the object.
...
[UPGRADE.md](UPGRADE.md) if you are moving an existing integration to 3.0.
...
| Outbound request queue and retry handling         | [docs/outbound-request-queue.md](docs/outbound-request-queue.md)                               |
| Upgrading an existing integration                 | [UPGRADE.md](UPGRADE.md)                                                                       |
