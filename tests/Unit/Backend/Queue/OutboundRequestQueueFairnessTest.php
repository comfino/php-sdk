...
final class OutboundRequestQueueFairnessTest extends TestCase
{
    ...
    public function testABrokenTenantDoesNotStallTheOthers(): void
    {
        ...
        self::assertSame(
            [['orderId' => '1', 'tenant' => 'shop_a'], ['orderId' => '1', 'tenant' => 'shop_b']],
            $handler->delivered
        );
    ...
    public function testAPausedTenantIsReported(): void
    {
        ...
        $queue = $this->makeQueue(
            new PerTenantHandler(['shop_broken' => new HttpErrorStub(403)]),
            pauseReporter: $pauses
        );
    ...
    {
        $queue = $this->makeQueue(
            new PerTenantHandler(['shop_broken' => new HttpErrorStub(401)]),
            maxAttempts: 1,
            tenantPauseSeconds: 900
        );
    ...
    {
        $queue = $this->makeQueue(
            new PerTenantHandler(['shop_a' => new HttpErrorStub(503)]),
            maxAttempts: 5,
            jitter: new FixedJitter(60)
        );
