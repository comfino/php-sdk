...
final class SettingsManagerTest extends TestCase
{
    ...
    private function createSettingsManager(?ConfigurationManager $configManager = null, string $apiKey = 'test-api-key', string $scope = ''): SettingsManager
    {
    ...
    public function testCachedLookupsArePartitionedByScope(): void
    {
        ...
        $this->assertSame(['A' => 'Shop A product'], $this->createSettingsManager(null, 'key_for_shop_a', 'shop_a')->getProductTypes());
        $this->assertNull(
    ...
    private function createConfigurationManager(array $configValues = []): ConfigurationManager
    {
        ...
        return ConfigurationManager::getInstance(
            array_combine(array_keys($configValues), array_fill(0, count($configValues), ConfigurationManager::OPT_VALUE_TYPE_JSON)),
