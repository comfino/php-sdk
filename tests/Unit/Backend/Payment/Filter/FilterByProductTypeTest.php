...
final class FilterByProductTypeTest extends TestCase
{
    public function testKeepsOnlyAllowedProductTypes(): void
    {
        $this->assertEqualsCanonicalizing(
            ...
            (new FilterByProductType([LoanType::PAY_LATER, LoanType::INSTALLMENTS_ZERO_PERCENT]))->getAllowedProductTypes(
    ...
    public function testReturnsEmptyWhenNoTypesMatch(): void
    {
        $this->assertSame(
            [],
            (new FilterByProductType([LoanType::BLIK]))->getAllowedProductTypes([LoanType::PAY_LATER, LoanType::CONVENIENT_INSTALLMENTS], $this->makeCart())
        );
    }

    public function testReturnsEmptyWhenAllowedListIsEmpty(): void
    {
        $this->assertSame([], (new FilterByProductType([]))->getAllowedProductTypes([LoanType::PAY_LATER], $this->makeCart()));
    }

    public function testReturnsEmptyWhenAvailableListIsEmpty(): void
    {
        $this->assertSame([], (new FilterByProductType([LoanType::PAY_LATER]))->getAllowedProductTypes([], $this->makeCart()));
    }
    ...
    public function testAllTypesRetainedWhenAllAreAllowed(): void
    {
        ...
        $this->assertEqualsCanonicalizing($types, (new FilterByProductType($types))->getAllowedProductTypes($types, $this->makeCart()));
    }
