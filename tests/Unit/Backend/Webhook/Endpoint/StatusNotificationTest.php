...
final class StatusNotificationTest extends TestCase
{
    ...
    {
        $request = $this->createMockRequest('POST', $this->endpointUrl, ['status' => 'WAITING_FOR_PAYMENT', 'externalId' => '12345']);
    ...
    public function testProcessRequestThrowsInvalidRequestForForbiddenStatus(): void
    {
        ...
        $request = $this->createMockRequest('POST', $this->endpointUrl, ['status' => 'CANCELLED', 'externalId' => '12345']);
    ...
    public function testProcessRequestUpdatesOrderStatusSuccessfully(): void
    {
        ...
        $request = $this->createMockRequest('POST', $this->endpointUrl, ['status' => $status, 'externalId' => $externalId]);
    ...
    public function testProcessRequestWithPutMethod(): void
    {
        ...
        $request = $this->createMockRequest('PUT', $this->endpointUrl, ['status' => $status, 'externalId' => $externalId]);
    ...
    public function testProcessRequestWithPatchMethod(): void
    {
        ...
        $request = $this->createMockRequest('PATCH', $this->endpointUrl, ['status' => $status, 'externalId' => $externalId]);
    ...
    {
        $request = $this->createMockRequest('POST', $this->endpointUrl, ['status' => 'ACCEPTED', 'externalId' => '12345']);
    ...
    {
        $request = $this->createMockRequest('POST', $this->endpointUrl, ['status' => 'REJECTED', 'externalId' => '12345']);
