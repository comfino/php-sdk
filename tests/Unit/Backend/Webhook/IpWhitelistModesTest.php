...
final class IpWhitelistModesTest extends TestCase
{
    ...
    {
        $whitelist = new IpWhitelist([IpUtils::COMFINO_SERVER_IP, '198.51.100.0/24'], allowLocalAddresses: false);
    ...
    public function testReportModeAllowsTheRequestAndNamesTheAddress(): void
    {
        ...
        $whitelist = IpWhitelist::forComfino(allowLocalAddresses: false, enforce: false, logger: $logger);
