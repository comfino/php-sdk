...
final class TenantResolverAndAdapterTest extends TestCase
{
    ...
    {
        self::assertSame('shop_1|status-notification|203.0.113.7', (new RateLimitKey('status-notification', '203.0.113.7', 'shop_1'))->toStorageKey());
        self::assertSame('-|status-notification|203.0.113.7', (new RateLimitKey('status-notification', '203.0.113.7'))->toStorageKey());
    }
    ...
    public function testTheLegacyLimiterAdapterTranslatesTheBooleanVerdict(): void
    {
        ...
        $legacy->method('isAllowed')->willReturnCallback(static fn (string $endpoint, string $client): bool => $client !== '203.0.113.9');
