...
final class ApiClientFactoryTest extends TestCase
{
    ...
    {
        $client = $this->factory->createClient($this->createMock(ClientInterface::class), $this->psr17, $this->psr17, 'api_key');
    ...
    {
        $shared = $this->factory->createSharedClient($this->createMock(ClientInterface::class), $this->psr17, $this->psr17);

        self::assertFalse(method_exists($shared, 'getApiKey'), 'A shared client must not carry a credential of its own.');
