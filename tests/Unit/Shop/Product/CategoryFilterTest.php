...
class CategoryFilterTest extends TestCase
{
    ...
    public function testIsCartValidWithComplexHierarchy(): void
    {
        ...
        $tree = $this->createCategoryTree([$grandparent, $sibling], [1 => $grandparent, 2 => $parent, 3 => $child, 4 => $sibling]);
    ...
    public function testIsCartValidWithMultipleExcludedCategories(): void
    {
        ...
        $tree = $this->createCategoryTree([$node1, $node2, $node3, $node4], [1 => $node1, 2 => $node2, 3 => $node3, 4 => $node4]);
