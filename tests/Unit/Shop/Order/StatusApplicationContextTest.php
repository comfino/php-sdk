...
final class StatusApplicationContextTest extends TestCase
{
    ...
    public function testOneTenantsApplicationDoesNotSuppressAnother(): void
    {
        ...
        $shopA->apply(static function (): void {
            ...
            self::assertFalse(
                StatusApplicationContext::isActive('shop_b'),
                'Shop B is not applying anything, so its hooks must react normally.'
            );
        });
    }
    ...
    {
        self::assertSame(
            StatusApplicationContext::forScope('shop_a'),
            StatusApplicationContext::forScope('shop_a')
        );
        self::assertNotSame(
            StatusApplicationContext::forScope('shop_a'),
            StatusApplicationContext::forScope('shop_b')
        );
    }
    ...
    {
        $observed = StatusApplicationContext::run(
            static fn (): bool => StatusApplicationContext::forScope()->isActiveInScope()
        );
