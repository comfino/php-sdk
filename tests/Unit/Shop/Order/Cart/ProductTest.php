...
final class ProductTest extends TestCase
{
    ...
    {
        $this->assertSame('Electronics', (new Product(name: 'X', price: 1, category: ' <em>Electronics</em> '))->getCategory());
    }
    ...
    {
        $this->assertSame('1234567890', (new Product(name: 'X', price: 1, ean: ' <span>1234567890</span> '))->getEan());
    }
    ...
    {
        $this->assertSame('https://example.com/img.jpg', (new Product(name: 'X', price: 1, photoUrl: ' https://example.com/img.jpg '))->getPhotoUrl());
    }
