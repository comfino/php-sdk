...
final class CustomerTest extends TestCase
{
    ...
    {
        $this->assertSame('John', (new Customer(' <b>John</b> ', 'Doe', 'j@e.com', '123', '1.2.3.4'))->getFirstName());
    }

    public function testGetLastNameReturnsTrimmedStrippedValue(): void
    {
        $this->assertSame('Doe', (new Customer('John', ' <i>Doe</i> ', 'j@e.com', '123', '1.2.3.4'))->getLastName());
    }

    public function testGetEmailReturnsTrimmedStrippedValue(): void
    {
        $this->assertSame('john@example.com', (new Customer('John', 'Doe', ' john@example.com ', '123', '1.2.3.4'))->getEmail());
    }

    public function testGetPhoneNumberReturnsTrimmedStrippedValue(): void
    {
        $this->assertSame('+48123456789', (new Customer('John', 'Doe', 'j@e.com', ' <span>+48123456789</span> ', '1.2.3.4'))->getPhoneNumber());
    }
