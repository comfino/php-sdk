...
final class ProductWidgetScriptHelperTest extends TestCase
{
    ...
    {
        $this->assertSame('https://sdk.comfino.pl/product/v1/comfino-widget.min.js', ProductWidgetScriptHelper::getScriptUrl(false));
        $this->assertSame('https://sdk.craty.pl/product/v1/comfino-widget.min.js', ProductWidgetScriptHelper::getScriptUrl(true));
        $this->assertSame('https://sdk.comfino.pl/product/v1/comfino-widget.min.js', ProductWidgetScriptHelper::getScriptUrl(false, 'generic'));
    }

    public function testGetBridgeScriptUrlUsesPerPlatformBridge(): void
    {
        $this->assertSame('https://sdk.comfino.pl/product/v1/comfino-prestashop-widget.min.js', ProductWidgetScriptHelper::getScriptUrl(false, 'PrestaShop'));
        $this->assertSame(
