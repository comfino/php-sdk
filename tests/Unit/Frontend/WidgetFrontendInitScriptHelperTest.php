...
class WidgetFrontendInitScriptHelperTest extends TestCase
{
    public function testRenderWidgetInitScriptWithValidParams(): void
    {
        ...
        $widgetInitScript = WidgetFrontendInitScriptHelper::renderWidgetInitScript($widgetInitCode, $widgetInitParams, $widgetInitVariables);
    ...
    public function testRenderWidgetInitScriptThrowsExceptionWithMissingParams(): void
    {
        ...
        WidgetFrontendInitScriptHelper::renderWidgetInitScript($widgetInitCode, $incompleteParams, $widgetInitVariables);
    }
    ...
    public function testRenderWidgetInitScriptThrowsExceptionWithMissingVariables(): void
    {
        ...
        WidgetFrontendInitScriptHelper::renderWidgetInitScript($widgetInitCode, $widgetInitParams, $incompleteVariables);
    }
    ...
    public function testRenderWidgetInitScriptConvertsBooleans(bool $inputValue, string $expectedOutput): void
    {
        ...
        $this->assertStringContainsString(
            ...
            WidgetFrontendInitScriptHelper::renderWidgetInitScript($widgetInitCode, $widgetInitParams, $widgetInitVariables)
        );
    }
    ...
    public function testRenderWidgetInitScriptOfferTypesArrayMustNotBePreSerialized(): void
    {
        ...
        $rendered = WidgetFrontendInitScriptHelper::renderWidgetInitScript($widgetInitCode, $widgetInitParams, $widgetInitVariables);
    ...
    {
        $this->assertFalse(WidgetFrontendInitScriptHelper::initScriptRequiresUpdate(WidgetFrontendInitScriptHelper::getInitialWidgetCode()));
    }
    ...
    public function testRenderWidgetInitScriptEscapesSpecialCharactersInStrings(string $maliciousInput, string $forbiddenOutput): void
    {
