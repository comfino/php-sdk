...
class SdkUrlBuilderTest extends TestCase
{
    ...
    {
        $this->assertSame('https://sdk.comfino.pl/sdk/v1/comfino-sdk.min.js', SdkUrlBuilder::getSdkScriptUrl(false));
    }

    public function testReturnsSandboxUrlInSandboxMode(): void
    {
        $this->assertSame('https://sdk.craty.pl/sdk/v1/comfino-sdk.min.js', SdkUrlBuilder::getSdkScriptUrl(true));
    }

    public function testHonorsCustomVersionInPath(): void
    {
        $this->assertSame('https://sdk.comfino.pl/sdk/v2/comfino-sdk.min.js', SdkUrlBuilder::getSdkScriptUrl(false, false, 2));

        $this->assertSame('https://sdk.comfino.pl/sdk/v3/comfino-sdk.min.js', SdkUrlBuilder::getSdkScriptUrl(false, false, 3));
    }
    ...
    public function testOverrideIgnoredWhenDevEnvUnset(): void
    {
        ...
        $this->assertSame('https://sdk.comfino.pl/sdk/v1/comfino-sdk.min.js', SdkUrlBuilder::getSdkScriptUrl(false, true));
    ...
    public function testOverrideIgnoredWhenShopOptInDisabled(): void
    {
        ...
        $this->assertSame('https://sdk.comfino.pl/sdk/v1/comfino-sdk.min.js', SdkUrlBuilder::getSdkScriptUrl(false, false));
    }
    ...
    public function testOverrideHonoredForAllowListedHostUnderDevEnv(): void
    {
        ...
        $this->assertSame('https://widget.craty.pl/sdk/v1/comfino-sdk.min.js', SdkUrlBuilder::getSdkScriptUrl(false, true));
    ...
    {
        $this->assertSame('https://sdk.comfino.pl/product/v1/comfino-widget.min.js', SdkUrlBuilder::getProductWidgetScriptUrl(false));

        $this->assertSame('https://sdk.craty.pl/product/v1/comfino-widget.min.js', SdkUrlBuilder::getProductWidgetScriptUrl(true));
    }

    public function testProductWidgetScriptUrlUsesPerPlatformBridgeWhenPlatformGiven(): void
    {
        $this->assertSame('https://sdk.comfino.pl/product/v1/comfino-prestashop-widget.min.js', SdkUrlBuilder::getProductWidgetScriptUrl(false, 'prestashop'));
    ...
    public function testProductWidgetScriptUrlIgnoresDevOverrideWhenOptInDisabled(): void
    {
        ...
        $this->assertSame('https://sdk.comfino.pl/product/v1/comfino-widget.min.js', SdkUrlBuilder::getProductWidgetScriptUrl(false, null, false));
    }

    public function testDefaultLogoUrlReturnsProductionOrSandboxHostByDefault(): void
    {
        $this->assertSame('https://sdk.comfino.pl/images/comfino/comfino_logo.svg', SdkUrlBuilder::getDefaultLogoUrl(false));

        $this->assertSame('https://sdk.craty.pl/images/comfino/comfino_logo.svg', SdkUrlBuilder::getDefaultLogoUrl(true));
    }
    ...
    public function testDefaultLogoUrlHonorsAllowListedDevOverride(): void
    {
        ...
        $this->assertSame('http://sdk-comfino.test:8081/images/comfino/comfino_logo.svg', SdkUrlBuilder::getDefaultLogoUrl(false, true));
    }
    ...
    public function testDefaultLogoUrlIgnoresDevOverrideWhenOptInDisabled(): void
    {
        ...
        $this->assertSame('https://sdk.comfino.pl/images/comfino/comfino_logo.svg', SdkUrlBuilder::getDefaultLogoUrl(false, false));
    }
    ...
    public function testDefaultLogoUrlIgnoresDevOverrideWhenUrlNotAllowListed(): void
    {
        ...
        $this->assertSame('https://sdk.comfino.pl/images/comfino/comfino_logo.svg', SdkUrlBuilder::getDefaultLogoUrl(false, true));
    }
}
