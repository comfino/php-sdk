...
final class CapabilityResolverTest extends TestCase
{
    ...
    {
        $this->assertSame(CapabilityResolver::fromThemeFamily('luma'), CapabilityResolver::fromThemeFamily('blank'));
    }
    ...
    {
        $this->assertSame(CapabilityResolver::fromThemeFamily('classic'), CapabilityResolver::fromThemeFamily('storefront'));
    }
