...
final class WidgetSdkInitScriptHelperTest extends TestCase
{
    ...
    private static function validVariables(): array
    {
        return [
            ...
            'LOGGING_TOKEN' => 'sdk-logging-token',
            'TRACK_ID' => 'sdk-track-id',
        ];
    }
    ...
    public function testRenderWidgetInitScriptContainsInjectedValues(): void
    {
        ...
        $this->assertStringContainsString('sdk-logging-token', $script);
        ...
        $this->assertStringContainsString('bootstrapWidget', $script);
    }
    ...
    public function testBoolParamRenderedAsJsLiteral(): void
    {
        ...
        $scriptTrue = WidgetSdkInitScriptHelper::renderWidgetInitScript(WidgetSdkInitScriptHelper::getInitialWidgetCode(), $paramsTrue, self::validVariables());
    ...
    public function testNullVariableRenderedAsJsNull(): void
    {
        ...
        $script = WidgetSdkInitScriptHelper::renderWidgetInitScript(WidgetSdkInitScriptHelper::getInitialWidgetCode(), self::validParams(), $vars);
    ...
    {
        $this->assertFalse(WidgetSdkInitScriptHelper::initScriptRequiresUpdate(WidgetSdkInitScriptHelper::getInitialWidgetCode()));
    }

    public function testInitScriptRequiresUpdateReturnsTrueForModifiedCode(): void
    {
        $this->assertTrue(WidgetSdkInitScriptHelper::initScriptRequiresUpdate('outdated script content'));
    }

    public function testGetInitialWidgetCodeHashIsConsistent(): void
    {
        $this->assertSame(WidgetSdkInitScriptHelper::getInitialWidgetCodeHash(), WidgetSdkInitScriptHelper::getInitialWidgetCodeHash());
    }
