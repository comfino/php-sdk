...
class FrontendHelperTest extends TestCase
{
    ...
    public function testGetLogoAuthKey(string $platformCode, string $platformVersion, string $pluginVersion, int $buildTimestamp): void
    {
    ...
    public function testGetLogoAuthHash(string $platformCode, string $platformVersion, string $pluginVersion, int $buildTimestamp): void
    {
    ...
    public function testGetPaywallLogoAuthHash(
        ...
        $this->assertNotEquals(FrontendHelper::getLogoAuthHash($platformCode, $platformVersion, $pluginVersion, $buildTimestamp), $authHash);
    }
    ...
    #[DataProvider('checkoutLoaderStylesheetUrlDataProvider')]
    public function testGetCheckoutLoaderStylesheetUrl(string $sdkScriptUrl, ?string $expected): void
    {
        $this->assertSame($expected, FrontendHelper::getCheckoutLoaderStylesheetUrl($sdkScriptUrl));
    }

    #[DataProvider('checkoutScriptUrlDataProvider')]
    public function testGetCheckoutScriptUrl(string $sdkScriptUrl, string $platform, ?string $expected): void
    {
        $this->assertSame($expected, FrontendHelper::getCheckoutScriptUrl($sdkScriptUrl, $platform));
    }

    /* Data providers */

    /** @return array<string, array{string, string, string|null}> */
    public static function checkoutScriptUrlDataProvider(): array
    {
        return [
            'production hyva' => [
                'https://sdk.comfino.pl/v1/comfino-sdk.min.js',
                'magento-hyva',
                'https://sdk.comfino.pl/checkout/v1/comfino-magento-hyva.min.js',
            ],
            'sandbox prestashop' => [
                'https://sdk.craty.pl/v1/comfino-sdk.min.js',
                'prestashop',
                'https://sdk.craty.pl/checkout/v1/comfino-prestashop.min.js',
            ],
            'legacy alias host preserved' => [
                'https://widget.comfino.pl/sdk/v1/comfino-sdk.min.js',
                'magento-hyva',
                'https://widget.comfino.pl/checkout/v1/comfino-magento-hyva.min.js',
            ],
            'dev with port' => [
                'http://sdk.comfino.test:8080/v1/comfino-sdk.min.js',
                'magento-hyva',
                'http://sdk.comfino.test:8080/checkout/v1/comfino-magento-hyva.min.js',
            ],
            'empty sdk url' => ['', 'magento-hyva', null],
            'malformed sdk url' => ['/v1/comfino-sdk.min.js', 'magento-hyva', null],
            'empty platform' => ['https://sdk.comfino.pl/v1/comfino-sdk.min.js', '', null],
            'platform with path traversal' => ['https://sdk.comfino.pl/v1/comfino-sdk.min.js', '../evil', null],
            'platform with slash' => ['https://sdk.comfino.pl/v1/comfino-sdk.min.js', 'a/b', null],
            'platform with uppercase' => ['https://sdk.comfino.pl/v1/comfino-sdk.min.js', 'Magento', null],
        ];
    }

    /** @return array<string, array{string, string|null}> */
    public static function checkoutLoaderStylesheetUrlDataProvider(): array
    {
        return [
            'production' => [
                'https://widget.comfino.pl/sdk/v1/comfino-sdk.min.js',
                'https://widget.comfino.pl/css/comfino-checkout.css',
            ],
            'sandbox' => [
                'https://widget.craty.pl/sdk/v1/comfino-sdk.min.js',
                'https://widget.craty.pl/css/comfino-checkout.css',
            ],
            'dev with port' => [
                'http://widget-comfino.test:8080/sdk/v1/comfino-sdk.js',
                'http://widget-comfino.test:8080/css/comfino-checkout.css',
            ],
            'empty string' => ['', null],
            'malformed (no scheme/host)' => ['/sdk/v1/comfino-sdk.js', null],
        ];
    }
