 ...
 * times a failing ComfinoPay API endpoint is actually contacted, which is what negative caching is there to bound.
 */
final class FailingHttpClient implements ClientInterface
{
    ...
    public function sendRequest(RequestInterface $request): ResponseInterface
    {
        ...
        throw new class ('ComfinoPay API is down.') extends RuntimeException implements ClientExceptionInterface {
        };
    }
}
