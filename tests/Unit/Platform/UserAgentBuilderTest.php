...
final class UserAgentBuilderTest extends TestCase
{
    ...
    public function testBuildsTheHostedConnectorShape(): void
    {
        ...
        self::assertSame('IDO Comfino [1.4.2], connector [1.4.2], PHP [8.3.1], connector.example.com', UserAgentBuilder::build($info));
    }
    ...
    public function testRendersUnknownForAbsentValues(): void
    {
        ...
        self::assertSame('IDO Comfino [1.4.2], connector [1.4.2], PHP [8.3.1], unknown', UserAgentBuilder::build($info));
    }
    ...
    public function testTreatsEmptyStringAsUnknown(): void
    {
        ...
        self::assertSame('PS Comfino [3.1.0], PrestaShop [unknown], PHP [unknown], unknown', UserAgentBuilder::build($info));
    }
    ...
    {
        $info = new HostedConnectorInfo('IDO', '1.4.2', 'connector.example.com', 'pl', '2026.1', 'connector', '8.3.1');

        self::assertSame('IDO Comfino [1.4.2], connector [2026.1], PHP [8.3.1], connector.example.com', UserAgentBuilder::build($info));
    }
}
