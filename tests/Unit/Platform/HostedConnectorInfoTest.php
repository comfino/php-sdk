...
final class HostedConnectorInfoTest extends TestCase
{
    ...
    {
        self::assertSame(PHP_VERSION, (new HostedConnectorInfo('PlatformName', '1.0.0'))->getPhpVersion());
    }

    public function testDefaultsTheNameSegmentToConnector(): void
    {
        self::assertSame('connector', (new HostedConnectorInfo('PlatformName', '1.0.0'))->getName());
    }

    /**
     * With no platform version to report, the honest answer is null — a deployment outside the shop has no separate
     * platform build to name.
     */
    public function testHasNoPlatformVersionByDefault(): void
    {
        self::assertNull((new HostedConnectorInfo('PlatformName', '1.4.2'))->getVersion());
    }

    public function testPrefersAKnownPlatformVersion(): void
    {
        self::assertSame('2026.1', (new HostedConnectorInfo('PlatformName', '1.4.2', null, 'pl', '2026.1'))->getVersion());
    }
    ...
    public function testGetUserAgentMatchesTheBuilder(): void
    {
        ...
        self::assertSame('PlatformName Comfino [1.4.2], PHP [8.3.1], connector.example.com', $info->getUserAgent());
    }
    ...
    {
        $info = new HostedConnectorInfo('PlatformName', '1.4.2', null, 'en', null, 'connector', '8.3.1');
