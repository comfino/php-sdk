 ...
 *
 * This is the **in-shop** variant of {@see ConnectorInfoInterface}: an integration running inside the platform knows
 * every member of it, so the nullable members of the parent interface are narrowed back to non-nullable here. An
 * integration deployed outside the shop cannot honestly implement this interface — it should use
 * {@see HostedConnectorInfo} instead, and both variants render their User-Agent through {@see UserAgentBuilder}.
 */
interface PlatformInfoInterface extends ConnectorInfoInterface
{
    /**
