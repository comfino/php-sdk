 ...
 *
 *  - **Good enough** for protecting a Comfino account's own quota from a runaway loop, where being within a factor of
 *    the worker count of the target rate is fine and the alternative is no limit at all.
