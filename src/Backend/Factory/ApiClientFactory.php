...
final class ApiClientFactory
{
     ...
     * @param string|null $apiKey Unique authentication key required for access to the ComfinoPay API
    ...
    public function createClient(
        ...
        $client = new Client(
            ...
            $streamFactory,
            $apiKey,
            retryExecutor: new RetryExecutor(new ExponentialBackoffRetryPolicy($timeouts, $maxRetries, $maxTotalTransferTimeout))
        );
    ...
    public function createSharedClient(
        ...
        return new SharedClient(
            ...
            $apiVersion,
            null,
            new RetryExecutor(new ExponentialBackoffRetryPolicy($timeouts, $maxRetries, $maxTotalTransferTimeout), null, $retryObserver),
            $requestObserver,
            $rateLimiter,
            $circuitBreaker
        );
