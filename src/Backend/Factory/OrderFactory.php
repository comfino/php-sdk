...
/**
 * Factory for creating ComfinoPay order objects.
 */
final class OrderFactory
{
    /**
     * Creates a ComfinoPay order object.
     *
     ...
     *
     * @return Order ComfinoPay order object (loan application) 100% ready to be sent to ComfinoPay API
     */
    public function createOrder(
        ...
        return new Order(
            $orderId,
            $returnUrl,
            new LoanParameters($orderTotal, $loanTerm, $loanType, $allowedProductTypes),
            new Cart(
                $cartItems,
                $orderTotal,
                $deliveryCost,
