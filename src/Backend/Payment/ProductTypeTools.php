...
final class ProductTypeTools
{
    ...
    {
        return array_map(static fn (string $productType): LoanTypeInterface => LoanType::fromApiValue($productType), $productTypes);
    }
    ...
    {
        return array_values(array_filter(array_map(static fn (string $productType) => LoanType::tryFrom($productType), $productTypes)));
    }
}
