...
/**
 * Filter by cart value upper limit for product types - allows only products with a value limit greater or equal to
 * the cart value.
 */
class FilterByCartValueUpperLimit implements ProductTypeFilterInterface
{
    /**
     * @param int[] $cartValueLimitsByProductType List of product types with their cart value upper limits
