 ...
 * a flat list of every merchant's key means any valid ComfinoPay signature is valid for every merchant — the request is
...
final class TenantWebhookContext
{
     ...
     */
    public function __construct(public readonly ?string $tenantKey, array $apiKeys, public readonly array $metadata = [])
    {
