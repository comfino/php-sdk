...
final class IpUtils
{
    ...
    /**
     * IPv4 addresses the Comfino **sandbox** notification server calls from.
     *
     * Originally recorded from integration testing rather than from a published specification (they are the egress
     * addresses of the sandbox environment's hosting).
     *
     * @var string[]
     */
    ...
    /**
     * Returns true if $ip matches one of the Comfino sandbox notification server addresses.
     *
     * @see COMFINO_SANDBOX_SERVER_IPS for how much these addresses are worth trusting.
     */
