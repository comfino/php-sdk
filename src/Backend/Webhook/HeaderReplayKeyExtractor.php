 ...
 *
 * **The Comfino API does not send such a header today.** The default names are the ones a future one would plausibly
...
final class HeaderReplayKeyExtractor implements ReplayKeyExtractorInterface
{
    ...
    public function __construct(
        ...
        private readonly bool $fallBackToSignature = false
    ) {
