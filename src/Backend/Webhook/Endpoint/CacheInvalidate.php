...
{
    public function __construct(string $name, string $endpointUrl, private readonly CacheItemPoolInterface $cache)
    {
    ...
    public function processRequest(ServerRequestInterface $serverRequest, ?string $endpointName = null): ?array
    {
        ...
        if ($this->cache instanceof TagAwareCacheInterface) {
            $this->cache->invalidateTags(array_intersect(parent::processRequest($serverRequest, $endpointName), $allowedTags));
        }
