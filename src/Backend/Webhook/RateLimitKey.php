 ...
 *
 * All Comfino webhooks arrive from Comfino's own infrastructure, so `$clientIdentifier` (the source IP) identifies the
 * *sender*, not the merchant - which is precisely why it cannot double as the tenant.
 */
