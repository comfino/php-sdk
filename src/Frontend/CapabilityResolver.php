 ...
 *
 * Capability hints are sent to the ComfinoPay backend only (not to the browser) and are used to build the
 * selector-profile knowledge base and CSS injection strategy for each platform.
 */
final class CapabilityResolver
{
     ...
     *
     * @param string $family Normalized theme family (e.g. "hyva", "luma", "blank", "classic", "storefront", "blocks",
     *                       "custom")
     *
