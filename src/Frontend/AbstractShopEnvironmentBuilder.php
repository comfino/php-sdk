...
abstract class AbstractShopEnvironmentBuilder
{
    ...
    /**
     * Builds the full backend report as a snake_case associative array (the same shape posted to
     * `log-shop-environment`). Used to expose the report on demand via the plugin configuration endpoint.
     *
     * @param string|null $testProductUrl URL of a test product for selector verification
     * @param array<string, mixed> $meta Additional platform-specific metadata
     *
     ...
     */
    public function buildReportArray(?string $testProductUrl = null, array $meta = []): array
    {
