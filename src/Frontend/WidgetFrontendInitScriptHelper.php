...
/**
 * Helper class for rendering the ComfinoPay widget initialization script for the widget-frontend facade.
 *
 * Targets widget-frontend.min.js and initializes the widget via ComfinoWidgetFrontend.init(). Use
 * WidgetSdkInitScriptHelper for new integrations that use the ComfinoPay Web SDK (comfino-sdk.min.js).
 */
