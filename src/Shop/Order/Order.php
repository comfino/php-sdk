...
/**
 * Order class representing a deferred payment transaction with ComfinoPay payment gateway (loan application).
 */
class Order implements OrderInterface
{
     ...
     * @param string|null $notifyUrl URL of the ComfinoPay API callback
